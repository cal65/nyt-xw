...
stats[Checks ==0]
plot_ts(stats[Puzzle_date >= '2017-07-01'])
...
ggplot(group_months(stats)) + 
  ...
  ggtitle('Timeline') + theme_few() + theme(plot.title = element_text(hjust=0.5))
ggsave('Month_timeline.jpeg', height=9.5, width=15, dpi=350)
